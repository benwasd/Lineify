...
public class Registry {
    public static void initializeDependencies(IDependencyContainer container) {
        ...
        container.registerContainerControlled(HistoryFragment.class, () -> new HistoryFragment(container.resolve(IWayPointRepository.class), container.resolve(TrackRecyclerViewAdapter.class)));
